  ...
  dwb_msgs__srv__DebugLocalPlan_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    dwb_msgs__srv__DebugLocalPlan_Request * data =
      (dwb_msgs__srv__DebugLocalPlan_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dwb_msgs__srv__DebugLocalPlan_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          dwb_msgs__srv__DebugLocalPlan_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  dwb_msgs__srv__DebugLocalPlan_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    dwb_msgs__srv__DebugLocalPlan_Response * data =
      (dwb_msgs__srv__DebugLocalPlan_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dwb_msgs__srv__DebugLocalPlan_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          dwb_msgs__srv__DebugLocalPlan_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
