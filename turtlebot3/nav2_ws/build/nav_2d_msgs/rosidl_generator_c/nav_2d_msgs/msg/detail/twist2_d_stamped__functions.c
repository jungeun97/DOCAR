...
nav_2d_msgs__msg__Twist2DStamped__create()
{
  ...
  nav_2d_msgs__msg__Twist2DStamped * msg = (nav_2d_msgs__msg__Twist2DStamped *)allocator.allocate(sizeof(nav_2d_msgs__msg__Twist2DStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav_2d_msgs__msg__Twist2DStamped__Sequence__init(nav_2d_msgs__msg__Twist2DStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav_2d_msgs__msg__Twist2DStamped *)allocator.zero_allocate(size, sizeof(nav_2d_msgs__msg__Twist2DStamped), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav_2d_msgs__msg__Twist2DStamped__Sequence * array = (nav_2d_msgs__msg__Twist2DStamped__Sequence *)allocator.allocate(sizeof(nav_2d_msgs__msg__Twist2DStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
