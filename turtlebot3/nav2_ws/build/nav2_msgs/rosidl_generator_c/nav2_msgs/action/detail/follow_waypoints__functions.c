  ...
  nav2_msgs__action__FollowWaypoints_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowWaypoints_Goal * data =
      (nav2_msgs__action__FollowWaypoints_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowWaypoints_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowWaypoints_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowWaypoints_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowWaypoints_Result * data =
      (nav2_msgs__action__FollowWaypoints_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowWaypoints_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowWaypoints_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowWaypoints_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowWaypoints_Feedback * data =
      (nav2_msgs__action__FollowWaypoints_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowWaypoints_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowWaypoints_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowWaypoints_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowWaypoints_SendGoal_Request * data =
      (nav2_msgs__action__FollowWaypoints_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowWaypoints_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowWaypoints_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowWaypoints_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowWaypoints_SendGoal_Response * data =
      (nav2_msgs__action__FollowWaypoints_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowWaypoints_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowWaypoints_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowWaypoints_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowWaypoints_GetResult_Request * data =
      (nav2_msgs__action__FollowWaypoints_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowWaypoints_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowWaypoints_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowWaypoints_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowWaypoints_GetResult_Response * data =
      (nav2_msgs__action__FollowWaypoints_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowWaypoints_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowWaypoints_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowWaypoints_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowWaypoints_FeedbackMessage * data =
      (nav2_msgs__action__FollowWaypoints_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowWaypoints_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowWaypoints_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
