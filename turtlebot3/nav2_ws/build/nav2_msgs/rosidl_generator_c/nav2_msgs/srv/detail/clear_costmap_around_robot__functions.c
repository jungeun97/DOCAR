...
nav2_msgs__srv__ClearCostmapAroundRobot_Request__are_equal(const nav2_msgs__srv__ClearCostmapAroundRobot_Request * lhs, const nav2_msgs__srv__ClearCostmapAroundRobot_Request * rhs)
{
  ...
  // window_size_x
  if (lhs->window_size_x != rhs->window_size_x) {
    return false;
  }
  // window_size_y
  if (lhs->window_size_y != rhs->window_size_y) {
    return false;
  }
  return true;
}
  ...
  nav2_msgs__srv__ClearCostmapAroundRobot_Request * output)
{
  ...
  // window_size_x
  output->window_size_x = input->window_size_x;
  // window_size_y
  output->window_size_y = input->window_size_y;
  return true;
}
