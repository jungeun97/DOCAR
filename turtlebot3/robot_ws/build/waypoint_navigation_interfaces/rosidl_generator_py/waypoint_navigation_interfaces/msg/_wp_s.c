...
bool waypoint_navigation_interfaces__msg__wp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("waypoint_navigation_interfaces.msg._wp.Wp", full_classname_dest, 41) == 0);
  }
  waypoint_navigation_interfaces__msg__Wp * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of Wp */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("waypoint_navigation_interfaces.msg._wp");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Wp");
