...
static const _GetWps_Request_type_support_symbol_names_t _GetWps_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, waypoint_navigation_interfaces, srv, GetWps_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, waypoint_navigation_interfaces, srv, GetWps_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, waypoint_navigation_interfaces, srv, GetWps_Request)() {
  return &::waypoint_navigation_interfaces::srv::rosidl_typesupport_c::GetWps_Request_message_type_support_handle;
}
...
static const _GetWps_Response_type_support_symbol_names_t _GetWps_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, waypoint_navigation_interfaces, srv, GetWps_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, waypoint_navigation_interfaces, srv, GetWps_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_waypoint_navigation_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, waypoint_navigation_interfaces, srv, GetWps_Response)() {
  return &::waypoint_navigation_interfaces::srv::rosidl_typesupport_c::GetWps_Response_message_type_support_handle;
}
...
static const _GetWps_type_support_symbol_names_t _GetWps_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, waypoint_navigation_interfaces, srv, GetWps)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, waypoint_navigation_interfaces, srv, GetWps)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, waypoint_navigation_interfaces, srv, GetWps)() {
  return &::waypoint_navigation_interfaces::srv::rosidl_typesupport_c::GetWps_service_type_support_handle;
}
