...
#ifndef WAYPOINT_NAVIGATION_INTERFACES__SRV__DETAIL__ADD_WP__FUNCTIONS_H_
#define WAYPOINT_NAVIGATION_INTERFACES__SRV__DETAIL__ADD_WP__FUNCTIONS_H_
...
/// Create srv/AddWp message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * waypoint_navigation_interfaces__srv__AddWp_Request__init().
...
/// Destroy srv/AddWp message.
/**
 * It calls
 * waypoint_navigation_interfaces__srv__AddWp_Request__fini()
...
/// Check for srv/AddWp message equality.
/**
...
/// Initialize array of srv/AddWp messages.
/**
...
/// Finalize array of srv/AddWp messages.
/**
 * It calls
 * waypoint_navigation_interfaces__srv__AddWp_Request__fini()
...
/// Create array of srv/AddWp messages.
/**
 * It allocates the memory for the array and calls
 * waypoint_navigation_interfaces__srv__AddWp_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AddWp messages.
/**
 * It calls
 * waypoint_navigation_interfaces__srv__AddWp_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AddWp message array equality.
/**
...
/// Copy an array of srv/AddWp messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * waypoint_navigation_interfaces__srv__AddWp_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_waypoint_navigation_interfaces
...
/**
 * It calls
 * waypoint_navigation_interfaces__srv__AddWp_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_waypoint_navigation_interfaces
...
/**
 * It allocates the memory for the array and calls
 * waypoint_navigation_interfaces__srv__AddWp_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_waypoint_navigation_interfaces
...
/**
 * It calls
 * waypoint_navigation_interfaces__srv__AddWp_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // WAYPOINT_NAVIGATION_INTERFACES__SRV__DETAIL__ADD_WP__FUNCTIONS_H_
